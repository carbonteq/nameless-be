// import { EmailDto } from "@app/dtos/email.dto";
// import type { BaseDto, DtoValidationResult } from "@carbonteq/hexapp";
// import {
...
// 	Query(queryName, new ApplyDtoPipe<EmailDto>(EmailDto.create));
